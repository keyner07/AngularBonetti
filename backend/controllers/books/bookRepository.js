...
function updateBook(idBook, title, author) {
    try {
        if(author) {
            return bookModel.updateOne({_id: idBook}, {$set: { author: author}});
        }
        else if(title){
            return bookModel.updateOne({_id: idBook}, {$set: { title: title}});
        }
        else if(title && author){
            return bookModel.updateOne({_id: idBook}, {$set: { title: title, author: author}});
        }
